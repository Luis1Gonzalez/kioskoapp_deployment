...
const ResumenProducto = ({ prodResu }) => {
    ...
    <div className="shadow p-5 mb-3 flex flex-col gap-10 items-center">
      ...
      <div className="md:w-4/6 flex flex-col items-center">
        ...
        <p className="text-xl font-bold mt-2 text-amber-500">
          Precio: {formatearDinero(prodResu.precio)}
        </p>
        <p className="text-md font-bold mt-2 text-gray-500">
          Subtotal: {formatearDinero(prodResu.precio * prodResu.cantidad)}
        </p>
      </div>
      ...
      <div>
        <button
          ...
          onClick={() => handleEditarCantidades(prodResu.id)}
        >
          <svg
        ...
        <button
          ...
          onClick={() => handleEliminarProducto(prodResu.id)}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
